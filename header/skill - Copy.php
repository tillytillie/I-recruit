<?php
session_start();if (strlen($_SESSION['id']==0)) {
    ...
    <button type="button" data-toggle="collapse" data-target="#navbarcollapse" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation" class="navbar-toggler navbar-toggler-right"><span class="fa fa-bars"></span></button>
        <div id="navbarcollapse" class="collapse navbar-collapse">
            ...
            <li class="nav-item"><a href="article.php" class="nav-link link-scroll">Articles</a></li>
                ...
                <?php echo'  <li class="nav-item"><a class="nav-link link-scroll btn btn-danger" href="../loginsystem/profile.php"><i class="fa fa-user"></i> Profile</a></li>';
?>
            </ul>
        </div>
    </div>
...
<div class="bgimg">
  ...
  <div class="bottomleft blockquote">
    <p>We offer various skills that will make you to be independent and makes you stand out among your collegues. 
        When the skill sections are ready you will be able to enrol into various classes  
    </p>
  </div>
</div>
  <!-----------------------------------------------------Footer------------------------------>
